...
def generate_launch_description():
    ...
    ign_bridge = Node(
        ...
        arguments=[
            ...
            "/front_camera_topic" + "@sensor_msgs/msg/Image" + "[ignition.msgs.Image",
            "/depth_front_camera_topic" + "@sensor_msgs/msg/Image" + "[ignition.msgs.Image",
            "/depth_front_camera_topic/points" + "@sensor_msgs/msg/PointCloud2" + "[ignition.msgs.PointCloudPacked",
